...
/*
1. Дефинирайте изглед BritishShips, който извежда за всеки британски кораб неговия клас, тип, 
   брой оръдия, калибър, водоизместимост и годината, в която е пуснат на вода.
*/
...
/*
2. Напишете заявка, която използва изгледа от предната задача, за да покаже броя оръдия и 
   водоизместимост на британските бойни кораби (type = 'BB'), пуснати на вода преди 1919.
*/
